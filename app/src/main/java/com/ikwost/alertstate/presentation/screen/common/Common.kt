package com.ikwost.alertstate.presentation.screen.common
...
import com.ikwost.alertstate.util.Constants.CLIENT_ID
...
//TODO() Change name to signInWithAuthorizedAccounts
fun signIn(
    activity: Activity,
...
//TODO() Change name to signInWithNotAuthorizedAccounts
fun signUp(
    activity: Activity,
    launchActivityResult: (IntentSenderRequest) -> Unit,
    accountNotFound: () -> Unit
